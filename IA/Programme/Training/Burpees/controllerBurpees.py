...
import asyncio
import time
from classTimer import _Timer
INSTALL_PACKAGE_INFOS = ['Proprieties','DefaultValues','Field','Image','Description','Buttons','LibPerformance','Questions','Default','LibPause','LibTimeRound','PerformanceIndex','LibRounds']
...
class Burpees:
    ...
    def getImage(self):
        imageModule = importlib.import_module('.'+self.Image.replace(".py",''), 'Training.Burpees')
