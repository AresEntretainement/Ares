...
import re
import importlib
from constants import CONST_TRAINING
from controllers.controllerRobot import ControllerRobot 
        ...
        if (isinstance(self.Type, list)):
            ...
            for element in self.Type:
                if(element in TypesList):
                    Temporal[element] = eval("self.controller" + element + "()")
                else:
            ...
            if(self.Type in TypesList):
                Temporal = eval("self.controller"+element+"()")
                return Temporal
            else:
                #Remplace Module Error
